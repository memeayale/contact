 ...
 <body>
     ...
     <h1>Your Name Goes Here</h1>
        <nav class="topnav" id="myTopnav">
            ...
            <a href="http://web-students.net/site38/web150/timeofday/" target="_blank">Time Of Day</a>
            <a href="http://web-students.net/site38/web150/Daily/template8.html" target="_blank">Daily Grind</a>
            <a href="http://web-students.net/site38/web150/DOM-play/events8.html" target="_blank">DOM Play</a>
            <a href="https://github.com/memeayale" target="_blank">GitHub</a>
            <a href="https://www.linkedin.com/in/meskerem-ayale-694a20116/" target="_blank">LinkedIn</a>
     ...
     -->  
       ...
       if(isset($_POST['Name'])){//show data
           ...
           // echo '</pre>';   
            ...
            $to  = 'memeayale85@gmail.com';//put your email here
